---
title: "Why My Portfolio's Domain Is My Name, Not \"Bali SEO\""
description: "A friend asked why I didn't buy a keyword-matching domain instead. The answer says something about how AI search is changing what actually gets rewarded."
tag: "practice notes"
date: 2026-07-16
slug: "why-my-domain-is-my-name"
sources:
  - title: "Exact Match Domains: How EMDs still offer a ranking advantage in 2025"
    url: "https://www.seoexamples.com/p/exact-match-domains-how-emds-still"
    publisher: "SEO Examples"
  - title: "Exact Match Domains: value in 2025"
    url: "https://searchengineland.com/exact-match-domains-value-453837"
...
It didn't disappear entirely, though. [A 2025 study of 500 search results](https://www.seoexamples.com/p/exact-match-domains-how-emds-still) found these domains still show up disproportionately in the top 3 spots, and need less accumulated authority to get there than an ordinary domain would. But the same study found something more telling: 70% of them only ever rank for that one exact phrase. They don't spread to anything related.
...
There's a second reason this matters more now than it used to. [Search Engine Land's 2025 analysis](https://searchengineland.com/exact-match-domains-value-453837) put it plainly: search, especially the AI-driven kind, is shifting toward rewarding brand recognition over keyword matching. An AI system deciding whether to cite a source isn't scanning the domain for the right words. It's checking whether it recognizes the name as a real, consistent entity it's seen before, across more than one place. A name is the thing that gets recognized. A keyword is just the thing that gets found, and increasingly, that's the smaller job.
...
<div class="cta-box">
  <p><strong>Thinking through domain strategy for your own site?</strong> Happy to talk it through.</p>
  <p class="cta-detail">Free 30-minute look either way, whether or not we end up working together. <a href="mailto:rajnanig22@gmail.com">Get in touch</a>.</p>
</div>
